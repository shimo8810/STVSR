...
def main():
    ...
    # 保存ディレクトリ
    # save didrectory
    model_dir_name = 'AEFINet_concat_parallel_opt_{}_ch_{}_fsize_{}'.format(args.opt, args.ch, args.fsize)
   ...
   # prepare model
    ...
    model_name = 'AEFINet_concat_opt_{}_ch_{}_fsize_{}.npz'.format(args.opt, args.ch, args.fsize)
